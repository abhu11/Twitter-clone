  ...
  return (
    <div className='flex space-x-2 p-5'>
        <img className='h-14 w-14 rounded-full object-cover'
         src='https://cdn.vectorstock.com/i/1000x1000/30/21/human-blank-face-with-eps10-vector-25623021.webp' alt=''/>
         ...
         <div className='flex flex-1 items-center pl-2'>
            <form className='flex flex-1 flex-col'>
                ...
                <div className='flex items-center'>
                    ...
                    <PhotographIcon className='h-5 w-5 cursor-pointer tranisition-transform duration-150
